...
for i in range(len(data_articles['text_processed'])):
  ...
  data_articles.loc[i,'d2v_pred4']=similar_doc[3][0]
  data_articles.loc[i,'d2v_sim4']=similar_doc[3][1]

  data_articles.loc[i,'d2v_pred5']=similar_doc[4][0]
  data_articles.loc[i,'d2v_sim5']=similar_doc[4][1]

  data_articles.loc[i,'d2v_pred6']=similar_doc[5][0]
  data_articles.loc[i,'d2v_sim6']=similar_doc[5][1]

  data_articles.loc[i,'d2v_pred7']=similar_doc[6][0]
  data_articles.loc[i,'d2v_sim7']=similar_doc[6][1]
